...
result = pd.merge(df_customer,df_orders,how="inner")
result = pd.merge(df_customer,df_orders,how="left")
result = pd.merge(df_customer,df_orders,how="right")
result = pd.merge(df_customer,df_orders,how="outer")
print(result)
'''
